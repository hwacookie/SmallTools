...
//	void saveList(String aStyleName, String aWordType, String aLines, AsyncCallback<Void> callback);
//	void loadList(String aStyleName, String aWordType, AsyncCallback<String> callback);
